...
const Expense = () => {
    return (
        <div className="container">
              ...
              <div className="card">
                <div className="card-header card-h card-header-primary">
                    <div className="card-p">
                        ...
                        <p className="card-category">Take purchasing expense photo </p>
                    </div>
            ...
            <div className="col-md-6">
              <div className="card">
                <div id="card-exp" className="card-header card-header-primary">
                  <h4 className="card-title ">Latest Expense Table</h4>
                  <p className="card-category"> Here is a last 6 expense for this month</p>
                </div>
                <div className="card-body">
